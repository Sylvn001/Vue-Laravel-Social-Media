...
<div class="row">
    <div class="card">
            ...
            <div class="row valign-wrapper">
                ...
                <grid-vue tamanho="11">
                    <span class="black-text">
                        <strong>
                            <router-link class="black-text" :to="'/pagina/'+usuarioid +'/' + $slug(nome, {lower: true})"> {{nome}} </router-link>
                        </strong> - <small>{{data}}</small>
        ...
        <div class="card-action">
            <p>
                <a style="cursor:pointer; color:red" @click="curtida(id)"><i class="material-icons">{{curtiu}}</i>{{totalCurtidas}}</a>
            ...
            <p v-if="exibirComentarios" class="right-align">
                <input type="text" v-model="textoComentario" placeholder="Comentar" name="">
                <button v-if="textoComentario" @click="comentar(id)" class="btn waves-effect waves-light blue" placeholder="Comentar"> <i class="material-icons">send </i> </button>
            </p>
